def geometra():
    ...
    In fase di selezione, a ciascun possibile calcolo
    corrisponde un valore numerico:
    - Area Quadrato: 1
    - Area Rettangolo: 2
    - Area Triangolo: 3
    - Area Cerchio: 4
    ...
    if scelta == 1:
        ...
        print(f"L'Area del Rettangolo, avente base {base} e "
              f"altezza {altezza} è: {base * altezza}")
    elif scelta == 3:
        print("Hai scelto: Area Triangolo")
        base = float(input('Inserisci il valore della base '))
        altezza = float(input('Inserisci il valore dell´altezza '))
        print(f"L'Area del Triangolo, avente base {base} e "
              f"altezza {altezza} è: {(base * altezza) / 2}")
    elif scelta == 4:
